...
function displayNotification(status, content, showTime) {
    ...
    if (document.querySelectorAll(".notification")) {
		existingCount = document.querySelectorAll(".notification").length;
    };
    ...
    switch(status) {
            case "error":
				element.className += " notification-error";
                break;
            case "success":
            ...
            case "info":
                ...
                break;
            default:
				element.className += " notification-" + status;
				break;
    }
